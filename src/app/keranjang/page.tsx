    ...
    <div className="container mx-auto p-4 md:p-8">
      <div className="flex justify-between items-center mb-6" >
        <h1 className="text-3xl font-bold text-gray-800 mb-6">
          Keranjang Belanja ({totalItem} item)
        </h1>
        <Link
          href="/"
      ...
      <div className="bg-white shadow-md rounded-lg p-6">
          ...
          >
            ...
            <div className="flex items-center">
              <input
                ...
                value={item.jumlah}
                onChange={(e) =>
                  updateJumlah(item.id, parseInt(e.target.value) || 0)
                }
                min="0" // Bisa juga min="1" kalau mau hapus otomatis pas 0
                className="w-16 text-center border border-gray-300 rounded-md p-1 mx-2 text-gray-600"
              />
              <button
        ...
        <div className="mt-6 pt-6 border-t border-gray-300">
          ...
          <Link
            href="/checkout"
            className="mt-6 w-full block text-center bg-green-500 hover:bg-green-600 text-white font-bold py-3 px-6 rounded-lg transition-colors"
          >
            Lanjut ke Checkout
          </Link>
        </div>
